...
SET OPTS=-use-network=true -library-path+=assets -theme "C:\Projects\Fireworks\Commands\Dev\FWConsole\assets\Ice.css" -keep-generated-actionscript=true  
...
rem C:\Software\Development\Flex\flex2_sdk_hf1\bin\mxmlc %OPTS% -output "Fireworks Console.swf" FireworksConsole.mxml


rem C:\Software\Development\Flex\flex2_sdk_hf1\bin\mxmlc.exe %OPTS% QuickFire.mxml
