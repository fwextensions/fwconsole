...
SET OPTS=-use-network=true -warn-no-type-decl=false -library-path+=assets -library-path+=..\lib -source-path+=..\src -keep-generated-actionscript=true -incremental=true -default-size 200 150
rem SET OPTS=-use-network=true -warn-no-type-decl=false -library-path+=assets -library-path+=..\lib -source-path+=..\src -theme assets\Ice.css -keep-generated-actionscript=true -incremental=true -default-size 200 150

"C:\Software\Development\Flex\Flex 3\flex_sdk_3.0.0.477\bin\mxmlc" %OPTS% -output FireworksConsole.swf FireworksConsole.mxml

rem copy "FireworksConsole.swf" "C:\Program Files\Adobe\Adobe Fireworks CS5\Configuration\Command Panels\Fireworks Console.swf"
rem copy "FireworksConsole.swf" "C:\Program Files\Adobe\Adobe Fireworks CS5.1\Configuration\Command Panels\Fireworks Console.swf"
